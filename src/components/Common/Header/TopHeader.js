          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-12 col-12">
              <div className="top_header_left">
                <p>
                  Özel koleksiyonlar için...<Link to="/shop">Daha fazlası...</Link>
                </p>
              </div>
            </div>
            <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                      ...
                      <ul className="custom_dropdown">
                        <li>
                          <Link to="/admin/live-chat">
                            <i className="fa fa-tachometer"></i> Admin Canlı Destek
                          </Link>
                        </li>
                        <li>
                          <Link to="/admin/product-panel">
                            <i className="fa fa-tachometer"></i> Ürün Ekle
                          </Link>
                        </li>
                        <li>
